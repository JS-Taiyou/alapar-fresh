    ...
    <>
      ...
      <main class="relative h-screen flex flex-col items-center justify-center p-6 bg-pattern">
        ...
        <header class="text-center mb-12 z-10">
          ...
          <h1 class="text-4xl font-bold tracking-tight text-white mb-2">A la par</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl z-10">
          ...
          >
            ...
            <h2 class="text-2xl font-semibold text-white mb-2">Nuevo registro</h2>
            <p class="text-slate-400">Crea un nuevo grupo de gastos para tu próximo viaje o evento.</p>
          ...
          <div class="group relative bg-surface p-8 border border-slate-700 rounded-custom hover:border-primary transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10 text-left opacity-60">
            <div class="mb-6 inline-block p-4 bg-slate-700 rounded-full text-slate-300">
              <svg class="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
              </svg>
            </div>
            <h2 class="text-2xl font-semibold text-white mb-2">Unirme a registro</h2>
            <p class="text-slate-400">Introduce un código de invitación para unirte a un grupo existente.</p>
